...
export interface ResearchMeta {
  ...
  abstract: { ar: string; en: string; es?: string; ur?: string };

  // Venue / Publication info
  venue: { ar: string; en: string; es?: string; ur?: string };
  location?: { ar: string; en: string; es?: string; ur?: string }; // City, Country
  publisher?: { ar: string; en: string; es?: string; ur?: string };
  ...
  // Keywords
  keywords?: { ar: string[]; en: string[]; es?: string[]; ur?: string[] };
...
export const researchMeta: ResearchMeta[] = [
  // رسالة الدكتوراه (العالَميّة) — جامعة الأزهر، طنطا ٢٠٠٨م
  {
    ...
    year: 2008,
    isoDate: '2008-01-01',
    date: { ar: '١٤٢٩هـ / ٢٠٠٨م', en: '1429 AH / 2008', es: '1429 H / 2008', ur: '۱۴۲۹ہجری / ۲۰۰۸ء' },
    title: {
      ...
      ur: 'امام ابن جُزَیّ الکلبی کے تفسیر «التسہیل لعلوم التنزیل» میں ترجیحات: دراسۃ و تقویم',
    },
    subtitle: {
      ...
      ur: 'رسالۂ دکتورا (درجۂ عالَمیّت) — تفسیر اور علوم القرآن، جامعۂ ازہر',
    },
    abstract: {
      ...
      ur: ‘یہ رسالۂ دکتورا اندلسی مفسر امام ابن جزیّ الکلبی (م ۷۴۱ھ) کے تفسیر التسہیل لعلوم التنزیل میں ترجیح کے منہج کا تأصیلی تطبیقی مطالعہ ہے۔ محقق نے ان اصولوں کو استخراج کیا ہے جن پر ابن جزیّ نے اپنی تریجح بنائی — قرآنی نص، سنتِ نبوی، آثار، اور عربی استعمال — پھر عقیدے، فقہ، لغت، تفسیر بالمأثور، قراءات اور علوم القرآن میں ان کی ترجیحات کا تعاقب کیا۔ پوری کاوش مفسرین کی آراء کے درمیان موازنہ کرتے ہوئے ان کے منہج کا نقدی جائزہ لیتی ہے۔ یہ تین ابواب، مقدمہ، تمہید، خاتمہ اور فہارس پر مشتمل تقریباً ۶۹۳ صفحات کا رسالہ ہے، جس پر جامعۂ ازہر — کلیۂ اصول الدین بطنطا نے ۱۴۲۹ھ/۲۰۰۸ء میں درجۂ دکتورا تفویض کیا۔’,
    },
    venue: {
      ...
      ur: ‘جامعۂ ازہر — کلیۂ اصول الدین والدعوۃ الاسلامیۃ، طنطا (قسم تفسیر وعلوم القرآن)’,
    },
    location: { ar: ‘طنطا — جمهوريّة مصر العربيّة’, en: ‘Tanta — Arab Republic of Egypt’, es: ‘Tanta — República Árabe de Egipto’, ur: ‘طنطا — جمہوریۂ عرب مصر’ },
    publisher: {
      ...
      ur: ‘اشراف: پروفیسر شکری شفیق الاخضر، اور پروفیسر صلاح الدین یوسف شلبی’,
    },
    pages: 693,
    language: ‘ar’,
    ...
    keywords: {
      ...
      ur: [‘ابن جزی الکلبی’, ‘التسہیل لعلوم التنزیل’, ‘ترجیح’, ‘تفسیر’, ‘علوم القرآن’, ‘قراءات’, ‘جامعۂ ازہر’],
    },
    featured: true,
  },
  // رسالة الماجستير (التخصص) — جامعة الأزهر، طنطا ١٤٢٤هـ/٢٠٠٣م
  {
    ...
    year: 2003,
    isoDate: '2003-01-01',
    date: { ar: '١٤٢٤هـ / ٢٠٠٣م', en: '1424 AH / 2003', es: '1424 H / 2003', ur: '۱۴۲۴ہجری / ۲۰۰۳ء' },
    title: {
      ...
      ur: 'امام ماتریدی کی تفسیر «تأویلات أہل السنۃ» — سورۃ الأعراف کی تحقیق و دراسۃ',
    },
    subtitle: {
      ...
      ur: 'رسالۂ ماجستیر (درجۂ تخصص) — تفسیر اور علوم القرآن، جامعۂ ازہر',
    },
    abstract: {
      ...
      ur: 'یہ ماجستیر رسالہ امام ابو منصور الماتریدی (م ۳۳۳ھ) کی تفسیر «تأویلات أہل السنۃ» کا تحقیقی ایڈیشن اور سورۃ الأعراف کی حدود میں دراسۃ پیش کرتا ہے۔ محقق نے متن کو مخطوطات کی بنیاد پر ضبط کیا، نسخوں کا موازنہ کیا، اور آیات، احادیث اور اقوالِ مفسرین کی تخریج کی، حواشی میں فروق النسخ درج کیں۔ تحقیق سے پہلے ایک تمہیدی دراسۃ ہے جو تین مباحث پر مشتمل ہے: ماتریدی کا عہد اور سوانح، تفسیر میں ان کی خدمات، اور عقیدے و احکام کی آیات میں ان کا منہج۔ یہ کام جامعۂ ازہر — کلیۂ اصول الدین بطنطا سے ۱۴۲۴ھ/۲۰۰۳ء میں تکمیل پذیر ہوا۔',
    },
    venue: {
      ...
      ur: 'جامعۂ ازہر — کلیۂ اصول الدین والدعوۃ الاسلامیۃ، طنطا، عالی تعلیم (قسم تفسیر وعلوم القرآن)',
    },
    location: { ar: 'طنطا — جمهوريّة مصر العربيّة', en: 'Tanta — Arab Republic of Egypt', es: 'Tanta — República Árabe de Egipto', ur: 'طنطا — جمہوریۂ عرب مصر' },
    publisher: {
      ar: 'إشراف: أ.د شكري شفيق الأخضر، وأ.د صلاح الدين يوسف شلبي',
  ...
  // بحث محكَّم مُقدَّم إلى مؤتمر AMJA العاشر (٢٠١٣م)
  {
    ...
    year: 2013,
    isoDate: '2013-03-01',
    date: { ar: 'مارس ٢٠١٣م', en: 'March 2013', es: 'Marzo de 2013', ur: 'مارچ ۲۰۱۳ء' },
    title: {
      ...
      ur: 'مغربی معاشرے میں خاتون اور دعوہ',
    },
    subtitle: {
      ...
      ur: 'دعوہ میں خاتون کی اہلیت اور اس کے حق پر، اور مغرب میں اس کی میڈیائی و عوامی موجودگی کے معاصر مسائل پر',
    },
    abstract: {
      ...
      ur: 'یہ مقالہ اسلام میں خاتون کی مکمل قانونی اہلیت — سیاسی، تکلیفی، شہادت میں اور پناہ دینے میں — کو مدلل کرتا ہے، پھر اسے مغربی معاشرے میں اس کے دعوتی نوازل پر منطبق کرتا ہے: مختلط مجامع میں خطاب، میڈیا میں موجودگی، پروگرام پیش کرنا، شوہر کا دعوتی سرگرمی سے روکنا، اور مساجد و کانفرنسوں میں مردوں کو وعظ۔ دونوں انتہاؤں کے درمیان ایک ضابطہ بند وسطی موقف پیش کیا گیا ہے جو خاتون کو انتشار اور انکفاء کے بغیر معاشرے کا فعال حصہ بناتا ہے۔',
    },
    venue: {
      ...
      ur: 'دسواں سالانہ کانفرنس — مجمع فقہاء الشریعۃ بأمریکا (AMJA)',
    },
    location: { ar: 'الولايات المتحدة الأمريكية', en: 'United States', es: 'Estados Unidos', ur: 'ریاستہائے متحدہ امریکہ' },
    pages: 47,
    language: 'ar',
    ...
    keywords: {
      ...
      ur: ['خاتون', 'دعوہ', 'فقہ الأقلیات', 'مغربی معاشرہ', 'اہلیت', 'میڈیا', 'AMJA'],
    },
  },
  // ورقة محكَّمة — مجمع فقهاء الشريعة بأمريكا (AMJA)، فقه ذبائح أهل الكتاب
  {
    ...
    year: 2026,
    isoDate: '2026-06-01',
    date: { ar: 'يونيو ٢٠٢٦م (النسخة المنقَّحة المنشورة) — والأصل ٢٠١٢م', en: 'June 2026 (revised published version) — original: 2012', es: 'Junio de 2026 (versión revisada publicada) — original: 2012', ur: 'جون ۲۰۲۶ء (نظرثانی شدہ اشاعت) — اصل: ۲۰۱۲ء' },
    title: {
      ...
      ur: 'اہل کتاب کے ذبائح قرآنی تناول میں: امریکی واقعیت بطور نمونہ',
    },
    subtitle: {
      ...
      ur: 'ان کے ذبائح کی حلت کی قرآنی تأصیل، اور اسے قاعدۂ غالب اور فقہ الذرائع کے ذریعے امریکی بازاروں پر منطبق کرنا',
    },
    abstract: {
      ...
      ur: 'یہ مقالہ اہل کتاب (یہود ونصاریٰ) کے ذبائح کے حکم کو قرآنی نقطۂ نظر سے دیکھتا ہے، اس بات کو واضح کرتے ہوئے کہ «اہل کتاب» کا وصف باقی ہے اور مؤاکلت و مناکحت کے احکام اسی پر موقوف ہیں۔ مقالہ قرآنِ مائدہ کی روشنی میں ان کے ذبائح کی اصل حلت پر اجماع ثابت کرتا ہے، پھر دو مستقل شروط — ذابح کی اہلیت اور ذبح کا طریقہ — کو الگ کرتا ہے، اور قاعدۂ غالب اور سد وفتح الذرائع کے ذریعے اسے امریکہ کے واقعے پر منطبق کرتا ہے۔ آخر میں مسلم اقلیت کے لیے عملی ضوابط اور ادارہ جاتی سفارشات۔',
    },
    venue: {
      ...
      ur: 'مجمع فقہاء الشریعۃ بأمریکا (AMJA) میں ہم مرتبہ جائزہ شدہ ورقہ سے ماخوذ دراسۃ؛ اصل نسخہ نویں سالانہ ائمہ کانفرنس (۲۰۱۲ء) میں «طعام و دوا میں حلال و حرام» محور کے تحت پیش کیا گیا',
    },
    location: { ar: 'الولايات المتّحدة الأمريكيّة', en: 'United States', es: 'Estados Unidos', ur: 'ریاستہائے متحدہ امریکہ' },
    pages: 35,
    language: 'ar',
  ...
  // دراسة فقهية أصولية مقاصدية — على هامش موسم الحج ١٤٤٧هـ
  {
    ...
    year: 2026,
    isoDate: '2026-06-06',
    date: { ar: 'موسم الحجّ ١٤٤٧هـ', en: 'Hajj Season 1447 AH (2026)', es: 'Temporada del Hach 1447 H (2026)', ur: 'حج سیزن ۱۴۴۷ہجری (۲۰۲۶ء)' },
    title: {
      ...
      ur: 'طوافِ وداع — الزام اور رفق کے درمیان',
    },
    subtitle: {
      ...
      ur: 'دلائل، استدلال کے طریقوں، اختلاف کے مناطات اور مقاصدی ترجیح کا علمی جائزہ',
    },
    abstract: {
    ...
    venue: {
      ...
      ur: 'فقہی اصولی مقاصدی تقابلی دراسۃ — حجِ ۱۴۴۷ھ کے موقع پر حتمی مدوّن نسخہ',
    },
    language: 'ar',
  ...
  // ورقة المؤتمر الدولي الأول — مركز المعرفة (ماليزيا) 2026
  {
    ...
    title: {
      ...
      ur: ‘قرآنی تفسیر — واقعیت کی تجدید اور ابزار کی تجدید کے درمیان: مصنوعی ذہانت بطور نمونہ’,
    },
    subtitle: {
      ...
      ur: ‘علمِ تفسیر کی ترقی میں مصنوعی ذہانت کے مقام کی اصولی قراءت’,
    },
    abstract: {
      ...
      ur: ‘یہ مقالہ ایک معرفتی سوال کو زیربحث لاتا ہے: کیا قرآنی تفسیر واقعیت اور معرفتی ابزار کی تجدید کے ساتھ تجدید کی صلاحیت رکھتی ہے، اور مصنوعی ذہانت اس مسار میں کہاں ہے؟ مقالہ تفسیر کی تاریخ کو متعاقب معرفتی ابزار — روایت، لغت، منطق، مقاصد، ادبی دراسات — کے استیعاب کی ایک سلسلہ کے طور پر پڑھنے کا منہج پیش کرتا ہے، پھر مصنوعی ذہانت کے سوال کو اس پر قیاساً اور اختباراً منطبق کرتا ہے۔ ایک مفاہیمی تجزیے اور ایک مسمّی لغوی ماڈل پر تطبیقی مثال کے ذریعے محقق اس نتیجے پر پہنچتا ہے کہ AI ایک معاون معرفتی ابزار ہے، نہ کہ متبادل مفسر۔ مقالہ ماڈلوں کی مخرجات میں احصائی خطأ اور زیفِ اسنادی کے درمیان تمیز کے لیے ایک اصولی معیار بھی فراہم کرتا ہے۔’,
    },
    venue: {
      ...
      ur: ‘پہلی بین الاقوامی علمی کانفرنس — مرکز المعرفۃ للبحوث والتعلیم (ملائیشیا)’,
    },
    location: {
      ar: ‘ماليزيا’,
      en: ‘Malaysia’,
    ...
    publisher: {
      ...
      ur: ‘قطر یونیورسٹی کلیۂ شریعہ اور اسلامی علوم اور امریکن امامز اکیڈمی کے تعاون سے — محور: «مصنوعی ذہانت کے دور میں اسلامی و عربی علوم: چیلنجز اور آفاق»’,
    },
    pages: 28,
    language: ‘ar’,
    ...
    keywords: {
      ...
      ur: [‘قرآنی تفسیر’, ‘ابزار کی تجدید’, ‘مصنوعی ذہانت’, ‘بڑے لغوی ماڈل’, ‘معرفت کی پیداوار’, ‘زیفِ اسنادی’, ‘معزَّز مفسر’],
    },
    featured: true,
  },
  ...
  // البحث الجديد ـ 2026
  {
    ...
    year: 2026,
    isoDate: '2026-05-17',
    date: { ar: 'مايو ٢٠٢٦', en: 'May 2026', es: 'Mayo de 2026', ur: 'مئی ۲۰۲۶ء' },
    title: {
      ...
      ur: 'ڈیجیٹل تبدیلی کے دور میں فتویٰ',
    },
    subtitle: {
      ...
      ur: 'مفتی کی اہلیت سے فتویٰ کی منظومے تک',
    },
    abstract: {
      ...
      ur: 'ایک علمی تحقیق جو ۲۰۱۸ء میں مجمع فقہاء الشریعۃ بأمریکا (AMJA) کی پندرہویں سالانہ ائمہ کانفرنس میں پیش کردہ ہم مرتبہ جائزہ شدہ مقالے کو توسیع دیتی ہے۔ تین حصوں (تأصیل، تحول، مقترحات) میں دس ابواب پر مشتمل، یہ کاوش پانچ اصیل مفاہیم متعارف کراتی ہے: «ڈیجیٹل افراتفری»، «معاصر مفتی کی مرکّب صلاحیتیں»، «ساتواں معاصر درجہ: اجتماعی ادارہ جاتی مجتہد»، «فقہ المآلات الرقمیۃ»، اور مفتی کے لیے AI استعمال کا ضابطہ۔ دس عملی اقدامات پر مشتمل «روڈ میپ» پر ختم ہوتی ہے۔',
    },
    venue: {
    ...
    keywords: {
      ...
      ur: ['فتویٰ', 'افراتفری', 'مصنوعی ذہانت', 'اقلیات فقہ', 'فتویٰ منظومہ', 'AMJA'],
    },
    featured: true,
  },
  ...
  // بحث المؤتمر العالمي العاشر — القاهرة 2025
  {
    ...
    year: 2025,
    isoDate: '2025-08-12',
    date: { ar: 'أغسطس ٢٠٢٥', en: 'August 2025', es: 'Agosto de 2025', ur: 'اگست ۲۰۲۵ء' },
    title: {
      ...
      ur: 'مصنوعی ذہانت کے دور میں ریاستہائے متحدہ میں فتویٰ کی واقعیت',
    },
    subtitle: {
    ...
    abstract: {
      ...
      ur: 'ایک ہم مرتبہ جائزہ شدہ مقالہ جو عالمی افتاء ہیئتوں کی دسویں عالمی کانفرنس — قاہرہ، اگست ۲۰۲۵ء — میں «مصنوعی ذہانت کے دور میں رشید مفتی کی تربیت» کے عنوان کے تحت پیش کیا گیا۔ مقالہ امریکہ میں ڈیجیٹل فتویٰ کی واقعیت کا نقشہ بناتا ہے، سائل اور مفتی دونوں کو درپیش تکنیکی، لسانی اور ثقافتی چیلنجز کا تعاقب کرتا ہے، اور ایک اصلاحاتی منہجی ڈھانچہ پیش کرتا ہے۔ تین ابواب: امریکہ میں فتویٰ کی واقعیت، ڈیجیٹل فتویٰ کے منہجی و شرعی چیلنجز، اور امریکی سیاق میں رشید ڈیجیٹل فتویٰ منظومے کی تعمیر کے خدوخال۔',
    },
    venue: {
    ...
    publisher: {
      ...
      ur: 'عالمی افتاء ہیئتوں کی جنرل سیکرٹریٹ — کانفرنس کارروائی، جلد ۵، محور ۴: AI اور ادارہ جاتی فتویٰ کاری کی ترقی — ص ۲۳۰۲–۲۳۴۳',
    },
    pages: 42,
    language: 'ar',
  ...
  // البحث الأصلي 2018
  {
    ...
    year: 2018,
    isoDate: '2018-02-25',
    date: { ar: 'فبراير ٢٠١٨', en: 'February 2018', es: 'Febrero de 2018', ur: 'فروری ۲۰۱۸ء' },
    title: {
      ...
      ur: 'فتویٰ — مفتی کی اہلیت اور فتویٰ کی افراتفری کے درمیان',
    },
    abstract: {
      ...
      ur: 'ایک ہم مرتبہ جائزہ شدہ مقالہ جو مجمع فقہاء الشریعۃ بأمریکا (AMJA) کی پندرہویں سالانہ ائمہ کانفرنس — ہیوسٹن، فروری ۲۰۱۸ء — میں پیش کیا گیا۔ مقالہ فتویٰ، مفتی، مستفتی، اہلیت اور افراتفری کی دقیق تعریفات پیش کرتا ہے، پھر مفتی کی شروط کو تین اقسام (تکلیفی، علمی، شخصی) میں تقسیم کرتا ہے اور آٹھ شخصی صفات کی تفصیل دیتا ہے۔ اپنے عہد میں فتویٰ کی افراتفری کی تشخیص کے بعد چھ اصلاحی مقترحات پر ختم ہوتا ہے۔',
    },
    venue: {
...
export const researchTypeLabels = {
  ...
  ur: {
    book: 'علمی تحقیق',
    'conference-paper': 'ہم مرتبہ جائزہ شدہ کانفرنس پیپر',
    'journal-paper': 'ہم مرتبہ جائزہ شدہ جرنل مضمون',
    'book-chapter': 'کتاب کا باب',
    monograph: 'مونوگراف',
  },
};
...
export const researchCategoryLabels = {
  ...
  ur: {
    'fiqh-and-fatwa': 'فقہ اور فتویٰ',
    imamship: 'امامت اور قیادت',
    minorities: 'اقلیتوں کا فقہ',

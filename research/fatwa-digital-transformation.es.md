---
title: "La fatwa en la era de la transformación digital: de la idoneidad del muftí al sistema de emisión de dictámenes"
locale: "es"
...
Este capítulo presenta los tres conjuntos clásicos de condiciones, y luego añade una aportación sustantiva:

- **Condiciones de la responsabilidad legal:** el islam, la pubertad y la razón.
- **Condiciones del conocimiento:** que sea de la gente del iytihād —conocedor del Libro y la Sunna, los fundamentos de la lengua y el fiqh, las reglas de la exégesis y los lugares del consenso y la discrepancia—; de sólido instinto jurídico y correcta derivación.
- **Cualidades personales:** la equidad, la integridad de la mente y la perspicacia, el escrúpulo y la rectitud, el conocimiento de la realidad, la observancia de la costumbre y los fines, la moderación y la evitación del fanatismo partidista.

**La aportación sustantiva — las cualificaciones compuestas del muftí contemporáneo:** en la era de la transformación digital, la formación legal por sí sola no basta; se requieren cinco competencias entrelazadas: (1) **la capacidad del muftí de redactar la fatwa** de un modo adecuado al medio digital sin menoscabo de su contenido; (2) **comprender el entorno psicológico** del consultante y del público de las plataformas; (3) **comprender las herramientas técnicas** mediante las cuales la fatwa se difunde y se recibe; (4) **prever las consecuencias** digitales y sociales a las que conduce la fatwa; (5) **el compromiso con las reglas de la veracidad mediática.** Estas «cualificaciones compuestas» son una extensión de las condiciones del conocimiento y del carácter, hecha necesaria por el cambio del medio y del alcance de la fatwa.
...
## Capítulo cuarto: el caos digital

El capítulo diagnostica cinco transformaciones entrelazadas que trasladaron la fatwa del espacio de los sabios al espacio de los algoritmos: (1) **el paso al video corto** (TikTok, Shorts, Reels), de modo que la fatwa pasó a entregarse en treinta segundos; (2) **el ascenso del «influencer religioso»**, que puede pasar de una figura local a una estrella transfronteriza en meses; (3) **la economía de la viralidad**, que premia la sensación y no la precisión; (4) **el fiqh interactivo**, que moldea la respuesta al deseo del público; (5) **la politización**. De estas transformaciones surgen cinco dimensiones del «caos digital»: **caos de la fuente** (¿quién es el muftí?), **caos de la redacción** (el titular sensacionalista y truncado), **caos del contexto** (una fatwa formulada para un entorno aplicada en otro), **caos de la recepción** (el ir de compras de fatwas) y **caos de la responsabilidad** (nadie rinde cuentas). Este caos no es un fenómeno pasajero, sino la expresión de un desplazamiento estructural en la relación del ser humano con el conocimiento religioso.

## Capítulo quinto: la fatwa como contenido digital

El capítulo ve al muftí como un «creador de contenido» sujeto a las presiones de la plataforma y el algoritmo, observa los rasgos del consultante digital, y luego propone **una carta ética —un código de conducta autoimpuesto** que el muftí adopta desde dentro—, fundada en seis principios: (1) **honestidad del titular**: que el titular resuma con verdad el contenido y no sea un cebo de clics; (2) **integridad de la representación**: tratar la cuestión por completo o remitirla, no truncarla; (3) **disciplina de la emoción**: la emoción tiene un lugar en la religión, pero no debe emplearse para engañar; (4) **observancia de las consecuencias** antes de publicar; (5) **la responsabilidad de la continuidad**: la responsabilidad del muftí no termina en el momento de la publicación; (6) **la veracidad mediática**. Cierra con tres patrones de fracaso de la fatwa digital tomados de la realidad. El código no es un estatuto legal, sino un compromiso propio para salvaguardar la confianza de la exposición.

## Capítulo sexto: la inteligencia artificial

La más grave y reciente de las transformaciones. El capítulo presenta el **marco técnico** de cómo funcionan los modelos de lenguaje y el fenómeno de la **alucinación** (inventar atribuciones y referencias sin fundamento), y luego determina **el lugar de la IA respecto del fiqh**: una herramienta que sirve al muftí y no lo sustituye —sobresale en la recuperación y el resumen, e incapaz de la derivación, la idoneidad y la responsabilidad—. Después propone **un código para el uso de la IA por el muftí** con cláusulas prácticas: **(1) la divulgación** del uso del modelo; **(2) la obligación de la revisión humana** de todo resultado; **(3) las materias prohibidas** a la máquina (lo que conlleva el riesgo de alucinación en las atribuciones legales); **(4) los controles para construir modelos legales fiables, de código abierto**, bajo la supervisión de la gente del conocimiento. El fin no es prohibir la herramienta, sino disciplinarla para que sea «un asistente potenciador, no un muftí sustituto».

## Capítulo séptimo: el fiqh digital de las minorías

Aborda la particularidad del contexto del musulmán en Occidente (en lo educativo, lo social, lo económico y lo legal), los desafíos compuestos donde la Sharía se cruza con el derecho civil, el lugar del muftí entre las constantes legales y las exigencias de la integración, y luego el espacio digital que agrava estas complejidades; y fundamenta un **fiqh de las consecuencias digitales**: que un mismo juicio puede diferir en su efecto según el entorno legal y socio-digital, de modo que la consecuencia debe traerse a la mente antes de emitir y difundir la fatwa.

## Capítulo octavo: del muftí individual al sistema colectivo de fatwa

Muestra por qué el muftí individual ya no basta en una era de sucesos compuestos y de rápida difusión, repasa los modelos de fatwa institucional y la experiencia de la Asamblea de Juristas Musulmanes de América (AMJA), y luego esboza los rasgos de un **sistema de fatwa** que se apoya en una **base de datos unificada de las fatwas** emitidas por cada organismo, y en una base de referencia disciplinada, que vincula al muftí individual con la institución y activa «el séptimo rango» (el muytahid colectivo institucional) en la práctica.
